                                        ...
                                        <?php $i++ ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                            ...
                                                            <button class="btn btn-outline-danger btn-sm delete" data-pro_id="{{ $product->id }}"
                    ...
                    <div class="modal-content">
                        ...
                        <form action="products/destroy" method="post">
                            ...
                            <div class="modal-body">
                                ...
                                <input class="form-control" name="product_name" id="product_namedelete" type="text" readonly>
                            </div>
                            <div class="modal-footer">
...
$(".delete").on("click",function()
    {
        ...
        let  product_name = $(this).attr("data-product_name");
         ...
         $("#product_namedelete").val(product_name)
